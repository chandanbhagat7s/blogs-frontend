...
export default function DeleteDialog({ handleClose, data }) {
    ...
    <React.Fragment>
      ...
      >
        <DialogTitle
          ...
          className="font-bold text-2xl px-3 py-2 bg-red-700 font-bold text-white"
        >
        ...
        <DialogContent>
          ...
          <div className="p-2">
            ...
            <input
              type="text"
              className={`p-2 border border-2 border-red-300`}
